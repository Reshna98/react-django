...
const DeveloperRegistrationForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post('http://127.0.0.1:8000/register_developer/', formDataToSend, {
        headers: {
      ...
      <div className="sign-in__wrapper1" style={{ overflow: "auto" }} >
        ...
        <Form className="shadow p-4 bg-white rounded" onSubmit={handleSubmit}>
          <img
            ...
            alt="logo"
          />
          <div className="h4 mb-2 text-center">Register as Developer</div>
          {showSuccessAlert && (
            <Alert
              className="mb-2"
              variant="success"
